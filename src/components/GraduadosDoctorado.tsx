    ...
    <div className="space-y-2">
      ...
      <p>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> &quot;Nacionalismo, fascismo y tradicionalismo en la Argentina moderna. Una historia&quot;
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Tesista:</b> Fernando J. Devoto.
        </span>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Fecha de defensa:</b> 8 de septiembre del año 2000.
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Jurado:</b> Dr. Robert Potash, Dr. Juan Carlos Torre, Prof. Enrique Zuleta Álvarez y Dr. Ezequiel Gallo (Director de Tesis).
        </span>
      </p>
    </div>
  ),
 2002: (
  <div className="space-y-6">
    <div className="space-y-1">
      ...
      <p>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> &quot;Empresarios y políticas de desarrollo en la Argentina y el Brasil. 1920-1955&quot;.
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Tesista:</b> Aníbal Pablo Jáuregui
        </span>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Jurado:</b> Prof. María Inés Barbero (UBA), Dr. Eduardo Míguez (Universidad Nacional del Centro), Dr. Fernando Rocchi (Universidad Di Tella) y Prof. José Luis Moreno (Universidad Nacional de Luján-Director de la Tesis).
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Fecha de defensa:</b> 5 de noviembre de 2002
        </span>
      </p>
    ...
    <div className="space-y-1 pt-4 border-t border-[#e7f5fa]">
      <p>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> &quot;Una inteligencia disciplinada y disciplinante. Los intelectuales autoritarios de derecha: su concepción estética-ideológica, la política y la representación de la sociedad. Argentina, primeras décadas del siglo XX&quot;, 545 pp., 2 tomos.
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Tesista:</b> Olga Echeverría
        </span>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Jurado:</b> Dra. Dora Barrancos (CONICET-UBA), Dra. Marta Bonaudo (CONICET-Universidad Nacional de Rosario), Dra. María Estela Spinelli (Universidad Nacional del Centro) y Prof. Susana Bianchi (Universidad Nacional del Centro-Directora de la Tesis)
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Fecha de defensa:</b> 13 de diciembre de 2002.
        </span>
      </p>
      <p className="text-[#134e5e] text-justify leading-relaxed mt-2">
  ...
  <div className="space-y-6">
    ...
    <div>
      ...
      <p>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> La utopía de Prometeo. Cultura antifascista e identidad comunista en la Argentina: entre París, Buenos Aires y Tandil, 1935-1976
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Tesista:</b> Ricardo Pasolini
        </span>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Jurado:</b> Dr. César Tcach (UNC), Dr. Hernán Otero (UNCPBA), Dr. Eduardo Hourcade (UNR) y Dr. Fernando J. Devoto (UBA - Director de Tesis)
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Fecha de defensa:</b> 27 de febrero de 2004
        </span>
    ...
    <div>
      <p>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> Comercio y crédito en La Pampa a inicios del siglo XX. Un estudio sobre el papel económico de los almacenes de ramos generales.
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Tesista:</b> Andrea Lluch
        </span>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Jurado:</b> Dr. Jorge Gelman (UBA), Dra. Noemí Girbal-Blacha (UNLP - UNQ), Dr. Osvaldo Barsky y Dr. Eduardo Miguez (UNCPBA - Director de Tesis)
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Fecha de defensa:</b> 8 de julio de 2004
        </span>
        <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <p>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> La experiencia inmigratoria italiana de la posguerra en la ciudad de Mar del Plata, 1947-1960
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Tesista:</b> Bettina Favero
        </span>
        <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Jurado:</b> Dr. José Luis Moreno (UNLu), Dr. Alejandro Fernández (UNLu), Dr. Marcelino Irían (UNCPBA) y Dr. Hernán Otero (UNCPBA - Director de Tesis)
        </span>
        <span className="block text-[#134e5e]">
          <b className="text-[#15394b]">Fecha de defensa:</b> 29 de noviembre de 2004
        </span>
        <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2005: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> Distinción y Legitimidad. Esplendor y ocaso de la elite social en la Buenos Aires de la Belle Époque.
        </span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Tesista:</b> Leandro Losada</span>
      <span className="block text-[#15394b]"><b className="text-[#15394b]">Jurado:</b> Dr. Fernando Devoto (UBA), Dr. Ezequiel Gallo (UTDT), Dr. Eduardo Zimmermann (U. San Andres) y Dr. Eduardo Miguez (UNCPBA- Director de Tesis)</span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Fecha de la defensa:</b> 24 de febrero de 2005.</span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> Valentín Saygüeque y la &quot;Gobernación Indígena de las Manzanas&quot;. Poder y etnicidad en la Patagonia noroccidental (1860-1881)
      </span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Tesista:</b> Julio Esteban Vezub</span>
      <span className="block text-[#15394b]"><b className="text-[#15394b]">Jurado:</b> Dra. Susana Bandieri (UNCo/Conicet), Dr. Guillaume Boccara (EHESS), Prof. Daniel Villar (UNS) y Prof. Raúl Mandrini (UNCPBA - Director de Tesis)</span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Fecha de la defensa:</b> 29 de marzo de 2005.</span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> El Peronismo después del peronismo. Entre la política de la resistencia y la resistencia de la política, 1955-1960
      </span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Tesista:</b> Julio Cesar Melon Pirro</span>
      <span className="block text-[#15394b]"><b className="text-[#15394b]">Jurado:</b> Prof. Susana Bianchi (UNCPBA), Dr. Tulio Halperin Donghi (Universidad de Berkeley), Dr. Juan Carlos Torre (UTDT) y Dr. Eduardo Miguez (UNCPBA-Director de Tesis)</span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Fecha de la defensa:</b> 26 de septiembre de 2005.</span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> Persistencia y transformaciones de una sociedad rural. Córdoba entre fines de la colonia y principios de la república.
      </span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Tesista:</b> Sonia Tell</span>
      <span className="block text-[#15394b]"><b className="text-[#15394b]">Jurado:</b> Dra. Sara Mata (UNS/Conicet), Prof. Raúl Fradkin (UBA/UNLu), Dr. Jorge Gelman (UBA/Conicet) y Dra. Silvia Palomeque (UNC - Directora de Tesis)</span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Fecha de la defensa:</b> 9 de diciembre de 2005.</span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
          <b className="text-[#15394b]">Título:</b> Actividades económicas y organización social en espacios de frontera. Bariloche 1880-1935: de pueblo de frontera a centro turístico internacional
      </span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Tesista:</b> Laura Marcela Méndez</span>
      <span className="block text-[#15394b]"><b className="text-[#15394b]">Jurado:</b> Dr. Andrés Regalsky (UNTF/Conicet), Dra. Marta Bonaudo (UNR/Conicet), Dra. Andrea Reguera (UNCPBA/Conicet) y Dra. Susana Bandieri (UNCo/Conicet - Directora de Tesis)</span>
      <span className="block text-[#134e5e]"><b className="text-[#15394b]">Fecha de la defensa:</b> 2 de diciembre de 2005.</span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2006: (
  <div>
    ...
    <span className="block text-[#15394b]">
      <b className="text-[#15394b]">Título:</b> &quot;Misioneros Jesuitas y Sociedades Indígenas en las Pampas a mediados del siglo XVIII. La presencia misionera jesuita al sur de la gobernación de Buenos Aires, entre 1740-1753. Un análisis de las relaciones entre las sociedades indígenas y la sociedad colonial de una región del extremo sur del Imperio Borbónico.&quot;
    </span>
    <span className="block text-[#134e5e]">
      <b className="text-[#15394b]">Tesista:</b> Daniel Marcelo Fabián Arias.
    </span>
    <span className="block text-[#15394b]">
      <b className="text-[#15394b]">Jurado:</b> Dr. Guillaume Boccara (EHESS - CERMA), Dra. Silvia Mabel Ratto (UNQ - CONICET), Dr. Daniel Santamaría (CEIC - CONICET) y Prof. Rodolfo Casamiquela (Director de Tesis).
    </span>
    <span className="block text-[#134e5e]">
      <b className="text-[#15394b]">Fecha de la defensa:</b> 10 de noviembre de 2006.
    </span>
    <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2007: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Disciplina y conflicto en la industria durante el Proceso de Reorganización Nacional (1976-1983).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Daniel Oscar Dicosimo.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Juan Suriano (PEHESA-CONICET), Dra. Mónica Gordillo (UNC-CONICET), Dr. Arturo Fernández (UNGS-CONICET), Lic. Héctor Palomino (UBA - Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de la defensa:</b> 20 de julio de 2007.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Crimen y justicia en la frontera (Buenos Aires, 1852-1880).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Melina Yangilevich.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Darío Barriera (UNR/Conicet), Prof. Raúl Fradkin (UBA/UNLu), Dr. Marcelino Iriani (UNCPBA/Conicet) y Dr. Eduardo Míguez (UNCPBA - Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de la defensa:</b> 31 de agosto de 2007.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;El desarrollo, la erradicación y la emergencia del paludismo y su vinculación con la consolidación de las políticas públicas de sanidad rural en la Argentina, entre fines del siglo XIX y mediados del XX.&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Adriana Álvarez.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Diego Armus (Swarthmore Collage, EEUU), Dra. Silvia Di Lisia (UNLPam); Dr. Hernán Otero (IEHS/CONICET), y Dra. Susana Belmartino (UNR - Directora de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de la defensa:</b> 5 de setiembre de 2007.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2008: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Estado y propiedad de la tierra. Instituciones, derechos, leyes y actores sociales. El caso de los partidos de Arenales y Ayacucho (Provincia de Buenos Aires, Argentina), 1824-1904.&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Valeria Araceli D&apos;Agostino.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. María Elena Infesta (CONICET/UNLP), Dra. Marta Valencia (CONICET/UNLP), Dra. Blanca Zeberio (CONICET/UNCPBA), Dra. Andrea Reguera (CONICET/UNCPBA, Directora de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 28 de marzo de 2008.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Estado y trabajo. Las políticas públicas y los trabajadores rurales pampeanos en los inicios del Estado &apos;interventor&apos;, 1925-1950.&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Luciano O. Barandiarán.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Mara Bonaudo (CONICET/UNR), Dra. Mónica Blanco (CONICET/UNCPBA), Dr. Enrique Mases (UNCOMA), Prof. Nicolás Iñigo Carrera (CONICET/UNCPBA, Co-director de la tesis, Directora: Blanca Zeberio CONICET/UNCPBA).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 23 de mayo de 2008.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;De cómo se construye la autoridad. Representaciones, prácticas y discursos en escuelas primarias de Tandil (1946-1983).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Paola Gallo.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Prof. Susana Bianchi (UNQ), Dra. Sandra Carli (CONICET/UBA), Dra. Silvina Gvirtz (CONICET/USA), Dr. Daniel Míguez (CONICET/UNCPBA/UNSAM, Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de la defensa:</b> 23 de mayo de 2008.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2009: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Un vecindario federal. La construcción del orden rosista en la frontera sur de Buenos Aires. Un estudio de caso (Azul y Tapalqué).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> María Sol Lanteri.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Ana Frega (Universidad de la República, Uruguay), Dr. Eduardo Míguez (UNCPBA/UNMdP), Dr. Gustavo Paz (CONICET/UNTREF/UBA), Dr. Jorge Gelman (CONICET/UBA, Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 19 de marzo de 2009.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Nacionalismo, militancia y violencia política. Los tacuaras en la Argentina, 1955-1969.&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Juan Manuel Padrón.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Samuel Amaral (UNTREF), Dr. Daniel Lvovich (CONICET-UNGS), Dr. Julio Melón Pirro (UNCPBA/UNMdP), Dra. María Matilde Ollier (UNSAM, Directora de tesis; Dra. Mónica Blanco, CONICET/UNCPBA, Co-Directora).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 29 de mayo de 2009.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;La construcción de la &apos;familia ideal&apos;. Nociones y representaciones en la Argentina del siglo XIX. La construction de la &apos;famille idéale&apos;. Notions et représentations dans l&apos;Argentine du XIXe siècle&quot; (Tesis en co-tutelle École des Hautes Études en Sciences Sociales, París; Doctorado en Historia UNCPBA, Tandil).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> María Selva Senor.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Michel Bertrand (Université de Toulouse II Le Mirail), Dra. Irène Théry (EHESS/CNRS), Dr. André Burguière (EHESS, Director de Tesis), Dr. Eduardo Míguez (UNCPBA, Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 9 de septiembre de 2009.
      </span>
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;La Nación de los Abipones ¿Un experimento político exitoso?&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Carlos D. Paz.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Ignacio Telesca (CONICET), Dr. Daniel Villar (UNS), Dr. Pablo Wright (UBA-CONICET), Prof. Raúl Mandrini (IEHS-UNCPBA, Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 16 de octubre de 2009.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Itinerarios migratorios. Integración en el Neuquén aluvional (1960-1991)&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Joaquín Perren.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Roberto Benencia, Susana Torres, Guillermo Velázquez, Hernán Otero (Director de tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 30 de marzo de 2009.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Indígenas y paisanos en La Pampa: Subalternización, ciclos migratorios, integración urbana (1870-1976).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Claudia Salomon Tarquini.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Prof. Raúl Fradkin, Prof. Raúl Mandrini, Dr. Juan Carlos Radovich, Dr. Daniel Villar (Director de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 3 de abril de 2009.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Vivir en los márgenes. La construcción social de un espacio de relaciones complejas y actores ocultos. La meseta Chubut (1880-1930).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Liliana Pérez.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. María Elba Argeri, Dra. Dora Barrancos, Dra. Graciela Blanco, Dra. Mónica Blanco (Directora de tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> ……
      </span>
    </div>
  </div>
),
...
2010: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Políticas de población en Argentina. Ideas, legislación y prácticas administrativas (1914-1955).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Carolina Alejandra Biernat.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Dora Barrancos, Dr. Eduardo Míguez, Dr. Andrés Reggiani, Dr. Hernán Otero (Director de tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 7 de mayo de 2010.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Vida pública y asuntos privados. La presencia de las mujeres en las comunidades del centro y sudeste bonaerense. Fines del siglo XIX y principios del XX.&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Yolanda de Paz Trueba.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. María Bjerg, Dra. Lila Caimari, Dr. Gustavo Paz, Dra. Lucía Lionetti (Directora de Tesis).
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 28 de mayo de 2010.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2011: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;De lo ideal a lo posible. Dirigencia e instituciones nacionales en la &apos;Confederación&apos; (1852-1862).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Ana Laura Lanteri.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Leandro Losada, Dr. Roberto Schmit, Dr. Eduardo Zimmermann. 
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. Valentina Ayrolo. 
        <b className="text-[#15394b] ml-2">Codirector:</b> Dr. Eduardo José Míguez.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 18 de marzo de 2011.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;La administración de la justicia penal en la provincia de Buenos Aires: (1877-1906)&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Gisela Sedeillan.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Osvaldo Barreneche, Dr. Roy Hora, Dr. Eduardo Miguez.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. Sandra Gayol.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 23 de marzo de 2011.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2012: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;El peronismo en La Pampa: conformación partidaria y construcción estatal, 1945-1955.&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Fabio Alonso.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dres. Julio Melon, Samuel Amaral y María L. Da Orden.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. María Estela Spinelli.
        </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 14 de diciembre de 2012.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;El contacto entre galeses, pampas y tehuelches: la conformación de un modelo de convivencia pacífica en la Patagonia central (1865-1885).&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Marcelo Gavirati.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dres. Eduardo Míguez, Susana Bandieri y Daniel Villar.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Prof. Raúl Mandrini.
        </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 18 de mayo de 2012.
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Estrategias y tramas empresariales del sector frutícola en el Alto Valle del Río Negro (1930-2005)&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Glenda Miralles.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Graciela Gutman, Dra. Andrea Lluch, Dra. Graciela Blanco y Lic. María Inés Barbero.
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Lic. María Inés Barbero.
        </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 14/12/2012
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2013: (
  <div className="space-y-8">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> La mies madura. Colonización agrícola y crecimiento económico en Santa Fe durante la segunda mitad del siglo XIX
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Juan Luis Martirén
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Julio Djenderedjian
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Eduardo Míguez, Dra. Hilda Sabato, Dr. Roy Hora y Dr. Julio Djenderedjian
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 15/04/2013
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Relaciones laborales paternalistas, identidad y clase obrera en la industria del cemento, Olavarría, 1940-1970.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Griselda Lemiez
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Daniel Dicósimo
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurado:</b> Dres. Juan Suriano, Silva Simonassi, Julio Melón Pirro y Daniel Dicósimo
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 12/11/2013
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Las políticas y las prácticas educativas del magisterio pampeano (1958-1966)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Silvia Castillo
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Lucía Lionetti
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurado:</b> Dres. Alejandro Cattaruzza, Adrián Ascolani, Paola Gallo y Lucía Lionetti
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 3/12/2013
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> De Militares a políticos. Los oficiales del Ejército Auxiliar del Perú y la carrera de la revolución, 1816-1831
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Alejandro Hernán Morea
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Valentina Ayrolo
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurado:</b> Dres. Alejandro Rabinovich, Gabriel Di Meglio, Eduardo Míguez y Valentina Ayrolo
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 29/11/2013
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Mandato divino y poder terrenal. La administración diocesana en el Obispado de Córdoba, 1778-1836
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> María Laura Mazzoni
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Valentina Ayrolo
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurado:</b> Dres. Roberto Di Stéfano, Jaime Peire, Melina Yangilevich y Valentina Ayrolo
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 13/12/2013
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> El proceso histórico de la lepra en la Argentina. Estado y sociedad. Médicos y enfermos, 1900-1970
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Irene Delfina Molinari
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dora Barrancos
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurado:</b> Dres. María Silvia Di Liscia, Mirta Lobato, Hernán Otero y Dora Barrancos
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 5/7/2013
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2014: (
  <div className="space-y-4">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Un golpe muy particular. Problemas políticos en la crisis del gobierno de Arturo Frondizi y la presidencia de José María Guido&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Carlos Hudson
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dres, Daniel Mazzei, César Tcach, Hernán González Bollo y Estela Spinelli.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Estela Spinelli
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 4/2/2014
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Diferenciación socioeconómica y estrategias políticas de pecheros. El caso castellano en perspectiva política y social en los siglos XIV y XV&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Silvina Mondragón
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Carlos Astarita, Carlos Calderón, Octavio Colombo y Laura Da Graca.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Director:</b> Laura Da Graca
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 23-9-2014
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> &quot;Representaciones sociales en torno a las sociedades indígenas en la historia escolar: el caso de la provincia de Catamarca (1957-2010)&quot;
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> José Vera
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Alejandro Isla, María Paula González, Sara Ortelli y Diana Mazzanti.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Director:</b> Diana Mazzanti
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 16-12-2014
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2016: (
  <div className="space-y-4">
    ...
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “La posición de la Argentina en la Guerra del Chaco (1932-1935). Variables internas y externas como condicionantes de la política exterior”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Maximiliano Zuccarino
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Beatriz Solveira, Dra. Beatriz Figallo, Dr. Daniel Dicósimo y Mg. José María Araya.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Mg. José María Araya
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 18-3-2016
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “Los inmigrantes italianos en el Territorio Nacional de La Pampa: Sociedades de Socorros Mutuos, política local y religión (1892-1942)”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Mariana Annecchini
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Mónica Bjerg, Dr. Alejandro Fernández, Dr. Marcelino Iriani y Dr. Hernán Otero.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Director:</b> Dr. Hernán Otero
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de Defensa:</b> 6-4-2016
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “Conservadores y Radicales en el “Interior” Bonaerense (Ayacucho, Azul, Lobería y Tandil, 1910-1943)”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Leonardo Fuentes
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Marcela Ferrari, Dr. Fernando Barba, Julio Melón y Dr. Estela Spinelli.
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Director:</b> Dra. Estela Spinelli
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 24-6-2016
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “Debates en la transición democrática. ‘UNIDOS’ y el proyecto de refundar el peronismo: pensamiento, proyecto político y práctica militante”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> María Teresa Brachetta
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Vicente Palermo, Dr. Gerardo Aboy Carlés, Dra. Estela Spinelli, Dra. Beatriz Bragoni
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Dra. Beatriz Bragoni
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 15-07-2016
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2017: (
  <div className="space-y-4">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “La dinastía norteña de Omrí y la ruptura con el pasado hebreo (ca. 883-841 a. C.)”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Magdalena Magneres
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dr. Ianir Milevski, Dra. Andrea Seri, Dra. Mercedes L García Bachmann, Dr. Marcelo Campagno
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Director:</b> Dr. Marcelo Campagno
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 11-12-2017
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2018: (
  <div className="space-y-8">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “Agentes de cambio. El clero secular, las comunidades y las instancias de poder en la construcción de la estructura eclesiástica de Buenos Aires en la segunda mitad del siglo XIX”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Lucas Matías Bilbao
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. María Elena Barral, Dres. Jaime Peire y Eduardo Míguez, Dra. Melina Yangilevich
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Dra. Melina Yangilevich
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 23-03-2018
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “Las empresas estatales extractivas y la configuración de identidades sociales ligadas al mundo del trabajo en la Patagonia Austral a lo largo del siglo XX: origen, desarrollo y desarticulación”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Daniel Antonio Cabral Marques
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Inés Barbero, Dra. Andrea Lluch, Dr. Daniel Dicósimo, Dra. Susana Bandieri
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Dra. Susana Bandieri
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 28-03-2018
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2019: (
  <div className="space-y-8">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Cartografía árabes. Trayectorias, territorialidad y redes sociales de inmigrantes sirio-libaneses en la Patagonia septentrional (1900-1955)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Matías Chávez
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Mónica Bjerg, Dr. Alejandro Fernández, Dr. Hernán Otero, Dr. Julio Vezub
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Director:</b> Dr. Julio Vezub
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 25-11-2019
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Portadores de cristianismo y civilización. Historia y representaciones de las misiones católicas en Argentina (Segunda mitad del siglo XIX)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Rocío Guadalupe Sánchez
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Valentina Ayrolo, Dr. Ignacio Martínez, Dr. Diego Mauro, Dra. Miranda Lida
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Miranda Lida
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 18-12-2019
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> El Rosismo y el antirrosismo en el interior. Tucumán en tiempos de la Federación (1832-1840): guerra, actores, prácticas y lenguajes
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Emmanuel Parrado
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Jurado:</b> Dra. Valentina Ayrolo, Dr. Gustavo Paz, Dr. Eduardo Míguez, Dra. Beatríz Bragoni
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Directora:</b> Dra. Beatriz Bragoni
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 21-06-2019
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2020: (
  <div className="space-y-8">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Trabajadores por cuenta propia en la industria metalúrgica y metalmecánica en el Partido de Tandil desde mediados de la década de 1970 hasta 2003
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Stella Cavalleri
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Prof. Nicolás Iñigo Carrera (UBA)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Héctor Palomino (UBA), Dra. Silvia Simonassi (UNR), Dr. Daniel Dicósimo (IEHS-UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 16 de noviembre de 2020
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Pugna política y movilización pluriétnica en el contexto revolucionario. La guerrilla pincheirina en las fronteras surandinas (1818-1832)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Carla Manara
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Susana Bandieri (UNComa)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Claudia Salomón Tarquini (UNLPam/CONICET), Dra. Silvia Ratto (UNQ/CONICET) y Dra. María Laura Cutrera (Instituto Ravignani/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 18 de noviembre de 2020
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2021: (
  <div className="space-y-8">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> ¿De quién es el pasado ranquel? La construcción de campos de interlocución en la reemergencia indígena. La Pampa y San Luis, 1970-2014
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Anabela Abbona
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Claudia Salomón Tarquini (UNLPam/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. Walter Delrío (UNComa/CONICET), Dra. Nidia Nacuzzi (UBA/CONICET), Dr. Marcelino Iriani (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 18 de marzo de 2021
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Iglesia y Poder político a comienzos del siglo XXI: Argentina 1999-2009, un acercamiento desde la prensa periódica nacional
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Fernando Urquiza
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Juan Cruz Esquivel (CEIL/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. José Zanca (UNR/CONICET), Dr. Mariano Fabris (UNMdP/CONICET), Dra. Olga Echeverría (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 19 de marzo de 2021
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Los primeros policías de la ciudad de Buenos Aires. Funciones, materialidades y territorios (1772-1825)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Agustina Vaccaroni
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. Valeria Ciliberto (UNMdP/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. Alejandro Agüero (UNC/CONICET), Dr. Diego Galeano (PUCRío), Dra. Melina Yangilevich (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 26 de mayo de 2021
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Bajo la égida del museo científico: de la diplomacia a la profesionalización entre Mar del Plata y la Lobería Grande (1925-1980)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Irene Brichetti
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Ricardo Pasolini (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Élida Blasco (Instituto Ravignani/CONICET), Dr. Máximo Farro (UNLP/CONICET), Dra. Lucía Lionetti (IEHS-UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 7 de junio de 2021
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Sirio-libaneses en el temprano poblamiento del noroeste del Chubut. Redes parentales y comerciales en un complejo proceso de asociacionismo y conflictividad, 1900-1950
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Gabriela Macchi
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Marcelino Iriani
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. Xosé Manoel Núñez Seixas (Universidad de Santiago de Compostela), Dr. Alejandro Fernández (UNLP), Dr. Joaquín Perren (UNComa/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 27 de agosto de 2021
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2022: (
  <div className="space-y-8">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Configuraciones del nacionalismo a mediados del siglo XX. Itinerarios Intelectuales e instituciones culturales: la experiencia mendocina en la encrucijada nacional e internacional
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Celina Fares
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Fernando Devoto
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. Daniel Lvovich (UNGS/CONICET), Dr. Martín Vicente (UNMdP/CONICET), Dr. Julio Melón Pirro (IEHS-UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 16 de diciembre de 2022
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Los trabajos de limpieza e higiene sanitaria frente a la crisis de la sociedad salarial: género y precarización laboral en el sector de servicios de salud municipal. Tandil, 1990-2020
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Florencia Minardo
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Daniel Dicósimo (IEHS-UNICEN)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Andrea Andújar (UBA-CONICET), Dra. Inés Pérez (UNMdP/CONICET), Dra. Marina Adamini (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 15 de marzo de 2022
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Dinámicas institucionales y políticas del Poder Judicial en la formación de la Provincia de La Pampa, 1953-1973
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Hernán Bacha
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. Marisa Moroni (UNLPam/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. Ernesto Bohoslavsky (UNGS/CONICET), Dr. Germán Soprano (UBA/CONICET), Dra. Gisela Sedeillan (IEHS-UNMdP/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 8 de julio de 2022
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Configuraciones y trayectorias culturales e intelectuales: género, clase y grupos etarios (Azul, 1920-1960)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> María Soledad González
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Olga Echeverría (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Ana Clarisa Agüero (UNC/CONICET), Dra. Paula Caldo (UNR/CONICET), Dr. Ricardo Pasolini (IEHS-UNICEN/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 4 de agosto de 2022
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2023: (
  <div className="space-y-8">
    <div>
      ...
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Emanciparse para preservar la costumbre: El orden natural católico en el Paraguay (1779-1840)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> José Ignacio WasingerEspro
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Gustavo Paz (Instituto Ravignani/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dr. Jorge Troisi-Meleán (UNLP), Emir Reitano (UNLP), Dr. Juan Ignacio Quintián (UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 13 de diciembre de 2023
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Estado y política. Sobre las formas estatales de tramitar la conflictividad social, 1997-2002
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Guillermina Laitano
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Daniel Dicósimo (IEHS-UNICEN)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Andrea Andújar (UBA/CONICET), Dr. Gonzalo Pérez Álvarez (UNP/CONICET), Luciano Barandiarán (UNICEN-CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 17 de febrero de 2023
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Herederas. Prácticas hereditarias de pequeños y medianos propietarios de Luján desde una perspectiva de género (mediados del siglo XVIII - principios del XIX)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Romina Soledad Coronello
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. Valeria Ciliberto (UNMdP/CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Marcela Aguirrezabala (UNS), Dra. Jaqueline Vasallo (UNC/CONICET), Dra. Lucía Lionetti (IEHS-UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 3 de octubre de 2023
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> El catolicismo social en la Argentina y México: orígenes, instituciones, figuras
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Mariana Elisabet Funkner
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Roberto Di Stéfano
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Cecilia Bautista García (UMSNH), Dr. Diego Mauro (UNR/CONICET), Dr. José Zanca (UNR/CONICET)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 30 de octubre de 2023
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
2024: (
  <div className="space-y-8">
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> Sociedad rural, sociedad urbana y fiestas populares. La Construcción de representaciones e identidades en el campo bonaerense (1969-1999)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Silvana Villanueva
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Director:</b> Dr. Luciano Barandiarán (UNICEN-CONICET)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Sandra Fernández (UNR/CONICET), Dr. Matías Casas (UNTREF/CONICET), Dra. Paola Gallo (IEHS-UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 23 de febrero de 2024
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
    ...
    <div>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Título:</b> “Itinerarios, textos y contextos: Una biografía intelectual de Juan Ricardo Nervi (1921-2004)”
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Tesista:</b> Leda García
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Directora:</b> Dra. Claudia Salomón Tarquini (CONICET-UNLPam)
      </span>
      <span className="block text-[#134e5e]">
        <b className="text-[#15394b]">Jurados:</b> Dra. Soledad Martínez Zuccardi (UNT-CONICET), Dra. Alejandra Mailhe (UNLP-CONICET) y Dra. Lucía Lionetti (IEHS-UNICEN)
      </span>
      <span className="block text-[#15394b]">
        <b className="text-[#15394b]">Fecha de defensa:</b> 10 de diciembre de 2024
      </span>
      <span className="block text-[#555] text-justify leading-relaxed mt-2">
...
export default function GraduadosDoctorado() {
      ...
      <div className="relative w-full max-w-5xl mx-auto px-0 py-0 select-none">
        ...
        <div className="relative bg-white/95 rounded-b-3xl rounded-t-xl shadow-xl border border-[#e7f5fa] p-8 min-h-[330px]">
          ...
          {tab === "premiadas" && (
            ...
            >
              <h3 className="text-2xl md:text-3xl font-extrabold text-[#15394b] mb-4 tracking-wide">
  ...
  <li>
    ...
    <span className="font-bold text-[#15394b]"> recibió el primer premio en el marco del Cuarto Premio de Investigación Doctoral en Historia del Derecho en América Latina, organizado por la editorial Tirant Lo Blanch, México, 2022.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo el premio a la Mejor Tesis Doctoral en el marco del VII concurso organizado por la Asociación Argentina de Historia Económica, 2020.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> recibió la Segunda Mención de Honor en el marco del I Premio Jorge Gelman a la Mejor Tesis Doctoral en Historia Rural, conferido por la Sociedad de Estudios de Historia Agraria (SEHA), España, 2020.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo el Premio a la Tesis de Doctorado del Fondo Editorial de la Honorable Legislatura del Chubut, 2015.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo el Premio Anual a Tesis doctorales de la Red de Viejas y Nuevas Enfermedades en el marco del VI Congreso de la Asociación Latinoamericana de Población (ALAP), Lima, Perú, 2014.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo el Premio a la Mejor Tesis Doctoral en el marco del IV Concurso organizado por la Asociación Argentina de Historia Argentina, 2014.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo el Premio a la Mejor Tesis Doctoral en el marco del III Concurso organizado por la Asociación Argentina de Historia Argentina, 2010.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> premio a la Mejor Tesis Doctoral, Centro de Estudios Históricos &quot;Prof. Carlos S. A. Segreti&quot;, 2010.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> mención especial en el concurso a la Mejor Tesis Doctoral, Centro de Estudios Históricos &quot;Prof. Carlos S. A. Segreti&quot;, 2010.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo el Premio a la Mejor Tesis Doctoral en el marco del I Concurso organizado por la Asociación Argentina de Historia Económica, 2006.</span>
  </li>
  <li>
    ...
    <span className="font-bold text-[#15394b]"> obtuvo la primera mención en el I Concurso a la mejor tesis doctoral organizado por la Asociación Argentina de Historia Económica, 2006.</span>
  </li>
</ul>
