    ...
    <div className="max-w-3xl mx-auto space-y-10">
      ...
      >
        <div className="absolute top-0 right-0 opacity-10 pointer-events-none select-none">
          <svg width="120" height="120" viewBox="0 0 100 100" fill="none">
            <ellipse cx="80" cy="20" rx="45" ry="25" fill="#f9623e" />
          </svg>
        </div>
        <div className="px-7 py-6 relative z-10">
          <div className="flex items-center gap-3 mb-3">
            <svg
              className="w-8 h-8 text-[#134e5e]"
              fill="none"
              viewBox="0 0 24 24"
            >
              <path
                d="M12 3l9 4.5v3c0 5-3.8 9.4-9 11-5.2-1.6-9-6-9-11v-3L12 3z"
                stroke="#134e5e"
                strokeWidth="2"
                fill="none"
              />
          ...
          <ul className="text-lg text-[#134e5e] font-semibold pl-2 space-y-2">
            <li>
              <span className="font-bold text-[#134e5e]">Director:</span>
      ...
      >
        <div className="absolute bottom-0 left-0 opacity-10 pointer-events-none select-none">
          <svg width="120" height="120" viewBox="0 0 100 100" fill="none">
            <ellipse cx="40" cy="90" rx="45" ry="25" fill="#134e5e" />
          </svg>
        </div>
        <div className="px-7 py-6 relative z-10">
          <div className="flex items-center gap-3 mb-3">
      ...
      >
        <div className="absolute top-0 left-0 opacity-10 pointer-events-none select-none">
          <svg width="120" height="120" viewBox="0 0 100 100" fill="none">
            <ellipse cx="20" cy="20" rx="45" ry="25" fill="#0f3f4d" />
          </svg>
        </div>
        <div className="px-7 py-6 relative z-10">
          <div className="flex items-center gap-3 mb-3">
            <svg
              className="w-8 h-8 text-[#0f3f4d]"
              fill="none"
              stroke="currentColor"
              strokeWidth={2}
              viewBox="0 0 24 24"
          ...
          <ul className="columns-1 md:columns-2 gap-8 text-lg text-[#134e5e] pl-5 list-disc [column-fill:_balance] font-semibold space-y-1">
            ...
            <li>
              Daniel Dicósimo{" "}
              <span className="text-sm text-gray-500">(emérito)</span>
            </li>
            <li>Paola Gallo</li>
            ...
            <li>
              Lucía Lionetti{" "}
              <span className="text-sm text-gray-500">(emérita)</span>
            </li>
            <li>
              Julio César Melón{" "}
              <span className="text-sm text-gray-500">(emérito)</span>
      ...
      <section
        ...
        className="relative rounded-xl overflow-hidden shadow-lg border border-[#134e5e]"
        style={{
          background: "linear-gradient(110deg, #e8f7fa 0%, #d0e7ef 100%)",
        }}
      >
        <div className="absolute bottom-0 right-0 opacity-10 pointer-events-none select-none">
          <svg width="120" height="120" viewBox="0 0 100 100" fill="none">
            <ellipse cx="80" cy="80" rx="45" ry="25" fill="#f9623e" />
          </svg>
        </div>
        <div className="px-7 py-6 relative z-10">
          <div className="flex items-center gap-3 mb-3">
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-2 text-lg text-[#134e5e] font-semibold">
              ...
              <ul className="space-y-1 list-disc pl-5">
                ...
                <li>
                  Dra. Alejandra Irigoin (Esc. de Economía y Cs. Políticas de
                  Londres)
                </li>
              ...
              <ul className="space-y-1 list-disc pl-5">
                ...
                <li>
                  Dra. Elizabeth Quay Hutchison (University of New Mexico)
                </li>
