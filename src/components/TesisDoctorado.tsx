    ...
    >
      ...
      <div className="relative z-10 px-8 py-12 md:py-14 rounded-2xl backdrop-blur-md bg-white/75 shadow-xl border border-[#134e5e]/15 mx-2">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#134e5e] tracking-wider drop-shadow">
            Tesis
          </h2>
        </div>
        <div className="text-[#15394b] text-lg md:text-xl font-medium space-y-4 leading-relaxed mb-10">
          ...
          <p>
            ...
            <b className="text-[#134e5e] underline underline-offset-2">
              30 créditos requeridos
            </b>
            , se adquiere la condición de doctorando/a y se está en condiciones
            de presentar la tesis con el aval del/la directora/a para su
            consideración por parte de un jurado formado por tres especialistas
            en la temática.
          </p>
          <p>
            La <b>presentación de la tesis</b> y su defensa deben cumplir con
            las normas formales y de evaluación establecidas en el reglamento
            del programa. El trabajo debe tener entre{" "}
            <b>75.000 y 150.000 palabras</b>, contener índice general, notas al
            pie y bibliografía ordenada según formato de ciencias sociales.
          </p>
          <p>
            Para guiarte en el proceso, te dejamos las{" "}
            <b>normas oficiales y la guía para proyectos de tesis</b>:
          </p>
        </div>
