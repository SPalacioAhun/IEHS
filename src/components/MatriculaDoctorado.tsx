...
export default function MatriculaDoctorado() {
  return (
    ...
    >
      {/* SVG Adorno Superior */}
      <svg
        className="absolute top-0 left-0 w-full h-20 opacity-40 pointer-events-none"
        viewBox="0 0 1440 80"
        fill="none"
      >
        <path
      ...
      {/* SVG Adorno Esquina */}
      <svg
        className="absolute top-10 right-4 w-32 h-32 opacity-15 rotate-12 pointer-events-none"
        viewBox="0 0 100 100"
      >
      ...
      {/* SVG Adorno Esquina */}
      <svg
        className="absolute bottom-2 left-0 w-28 h-28 opacity-10 -rotate-12 pointer-events-none"
        viewBox="0 0 100 100"
      >
      ...
      <div className="relative z-10 px-8 py-12 flex flex-col gap-7">
        <div className="flex items-center gap-3 mb-2">
          <svg
            className="w-10 h-10 text-[#134e5e]"
            fill="none"
            stroke="currentColor"
            strokeWidth={2}
            viewBox="0 0 24 24"
        ...
        <div className="text-[#15394b] text-lg md:text-xl font-medium space-y-4 leading-relaxed md:pl-6">
          <p>
            <b className="text-[#134e5e] uppercase tracking-wider">
              Matrícula anual y aranceles
            </b>
          </p>
          <p>
            <span className="font-bold text-[#134e5e]">Matrícula Anual:</span>
            <span className="font-bold text-[#134e5e]"> $62.000.</span>
            <br />
            <span className="text-[#134e5e]">
              Docentes de Universidades Nacionales, egresados de la Facultad de
              Ciencias Humanas de la UNICEN y becarios (CONICET, AGENCIA, etc.):{" "}
              <span className="font-bold text-[#134e5e]">$33.000</span>
            </span>
          </p>
          <p>
            <span className="font-bold text-[#134e5e]">
              Valor de los cursos para alumnos externos al Programa:
            </span>{" "}
            <span className="font-bold text-[#134e5e]">$26.000</span>
          </p>
          <p>
            <span className="font-bold text-[#134e5e]">
              Para los egresados de la Facultad de Ciencias Humanas, docentes de
              Universidades Nacionales y becarios (CONICET, AGENCIA, etc.), el
              arancel es de:
            </span>{" "}
            <span className="font-bold text-[#134e5e]">$16.000</span>
          </p>
          <p>
            <span className="font-bold text-[#134e5e]">
              Derecho de Defensa de Tesis:
            </span>{" "}
            <span className="font-bold text-[#134e5e]">$88.000</span>
          </p>
        </div>
        {/* Botón de descarga */}
