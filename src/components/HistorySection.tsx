...
export default function HistorySection() {
  return (
    <section className="relative w-full bg-[url('/frente.iehs.png')] bg-cover bg-center text-white min-h-[110vh]">
      {/* Overlay blanco translúcido */}
      <div className="absolute inset-0 bg-white/30"></div>
      <div className="relative max-w-4xl mx-auto px-4 py-20">
        {/* Título animado */}
        <motion.h1
          className="text-6xl font-extrabold mb-4 text-shadow-custom text-[#134e5e] text-outline-black"
        ...
        {/* Cuadro animado con los párrafos */}
        <motion.div
          className="bg-white/20 backdrop-blur-sm p-8 rounded-lg"
          initial={{ opacity: 0, y: 64 }}
          whileInView={{ opacity: 1, y: 0 }}
